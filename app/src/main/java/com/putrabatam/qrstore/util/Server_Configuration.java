...
public class Server_Configuration {
    //local_server
    //public static final String address_server = "https://192.168.1.13/API_STORE_MANAGEMENT/view/";
    //public static final String address_image = "http://192.168.1.13/API_STORE_MANAGEMENT/";
